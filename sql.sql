...
REPLACE INTO `list` (`ID`, `author`, `display_time`, `status`, `title`, `pageviews`) VALUES
...
REPLACE INTO `login` (`ID`, `user_name`, `password`) VALUES
	(1, 'admin', 'admin1'),
	(2, 'sa', 'sa'),
	(3, '123', '123456'),
	(4, 'CN', 'cn');
...
REPLACE INTO `question` (`ID`, `qtitle`, `qanswer`, `bz`, `caseid`) VALUES
	(1, '测试', 1, 0, 0);
